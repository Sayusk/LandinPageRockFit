      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
          ...
          <div className="lg:col-span-2">
            <button onClick={() => handleNavClick('#inicio')} className="focus:outline-none mb-4 block">
              <img src={logo} alt="RockFit Brasil" className="h-10 w-auto logo-light" />
            </button>
          ...
          {/* Links rápidos */}
          <div>
            <h4 className="text-xs font-semibold tracking-widest uppercase text-muted mb-4">Navegação</h4>
            <ul className="space-y-2.5">
              {QUICK_LINKS.map((link) => (
                <li key={link.href}>
                  <button
                    onClick={() => handleNavClick(link.href)}
                    className="text-sm text-light/60 hover:text-light transition-colors duration-200 focus:outline-none"
                  >
                    {link.label}
                  </button>
                </li>
          ...
          {/* Contato + CTA */}
          <div>
            <h4 className="text-xs font-semibold tracking-widest uppercase text-muted mb-4">Contato</h4>
            <ul className="space-y-2.5 mb-6">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-light/60 hover:text-light transition-colors flex items-center gap-2"
                >
                  <span className="text-brand">WhatsApp</span>
                  <span>(19) 99620-9656</span>
                </a>
              </li>
              <li>
                <a
        ...
        <div className="border-t border-white/[0.06] pt-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-5">
            <div className="flex items-center gap-5">
              <a href="/privacidade" className="text-xs text-muted/60 hover:text-muted transition-colors">
                Política de Privacidade
              </a>
              <a href="/termos" className="text-xs text-muted/60 hover:text-muted transition-colors">
                Termos de Uso
              </a>
            </div>
            {/* Developed by NervaLog */}
            <a
              href="https://www.linkedin.com/company"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 group opacity-60 hover:opacity-100 transition-opacity duration-200"
              title="NervaLog"
            >
              <span className="text-xs text-muted/70 group-hover:text-muted transition-colors whitespace-nowrap">
                Desenvolvido por
              </span>
              <img
                src={nervalogo}
              ...
              />
              <span className="text-xs font-semibold text-muted/70 group-hover:text-muted transition-colors whitespace-nowrap">
                NervaLog
              </span>
            </a>
          </div>
